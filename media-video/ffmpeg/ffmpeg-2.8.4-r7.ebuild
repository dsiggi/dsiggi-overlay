...
SCM="git-2"
EGIT_REPO_URI="git://github.com/ffmpeg/ffmpeg.git"
EGIT_BRANCH="release/2.8"
EGIT_COMMIT="6a1bf98b3af1d02946d6b151e53bb5a2300f88de"
...
IUSE="
	alsa +encode examples jack libressl oss pic static-libs test v4l mmal
	${FFMPEG_FLAG_MAP[@]%:*}
	${FFMPEG_ENCODER_FLAG_MAP[@]%:*}
"
