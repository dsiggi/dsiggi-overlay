...
if [ "${PV#9999}" != "${PV}" ] ; then
        ...
        SRC_URI="https://github.com/xbmc/FFmpeg/archive/refs/tags/${PV}-Matrix-19.1.tar.gz"
fi
...
IUSE="
	alsa chromium doc +encode oss pic static-libs test v4l +raspberry-pi
	${FFMPEG_FLAG_MAP[@]%:*}
	${FFMPEG_ENCODER_FLAG_MAP[@]%:*}
"
...
RDEPEND="
	...
	raspberry-pi? ( media-libs/mesa[video_cards_vc4] )
"
...
S=${WORKDIR}/FFmpeg-${PV}-Matrix-19.1
...
multilib_src_configure() {
	...
	use raspberry-pi && myconf+=( --disable-rpi --enable-sand --enable-hwaccels )
