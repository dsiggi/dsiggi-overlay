...
inherit eutils linux-info python-single-r1 multiprocessing autotools cmake-utils flag-o-matic
...
SRC_URI="https://github.com/xbmc/libdvdcss/archive/${LIBDVDCSS_COMMIT}.tar.gz -> libdvdcss-${LIBDVDCSS_COMMIT}.tar.gz
	...
	https://github.com/xbmc/xbmc/archive/${PN}-${CODENAME}.tar.gz -> ${P}.tar.gz"
...
IUSE="airplay alsa bluetooth bluray caps cec css dbus debug dvd joystick libusb lirc midi mysql nfs nonfree odroidc1 profile pulseaudio raspberrypi +samba sftp spectrum ssl test texturepacker udisks upnp upower +udev waveform webserver zeroconf"
...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	=media-video/ffmpeg-3.1.7:=[encode]
	mysql? ( virtual/mysql )
	...
	raspberrypi? ( =media-video/ffmpeg-3.1.7:=[mmal,omx-rpi]
			media-libs/raspberrypi-userland )
	odroidc1? ( media-libs/aml-odroidc1
